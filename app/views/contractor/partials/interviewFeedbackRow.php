        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <thead>
                        <tr>
                            <th colspan="2" class="project-name">
                                ...
                                <span class="label label-info pull-right">Feedback</span>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <div class="text-right">
                    <button type="button" class="btn btn-success btn-sm btn-action-control" data-id="<?php echo $interview->interview_id; ?>" data-action="project_confirm">Confirm - Start Project</button>&nbsp;
                    <button type="button" class="btn btn-success btn-sm btn-action-control" data-id="<?php echo $interview->interview_id; ?>" data-action="project_refuse">Refuse</button>
                </div>
            </div>
        </div>
    </div>
