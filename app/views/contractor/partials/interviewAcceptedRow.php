        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="text-right">
                    <button type="button" class="btn btn-success btn-sm btn-action-response-interview" data-interview-id="<?php echo $interview->interview_id; ?>" data-action="refuse">Revoke</button>
                </div>
            </div>
        </div>
    </div>
