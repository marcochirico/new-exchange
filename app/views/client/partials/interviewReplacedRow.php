            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="text-left">
                    <?php if ($interview->status == 12): ?>
                        ...
                        <button type="button" class="btn btn-primary btn-sm btn-action-control" data-id="<?php echo $interview->interview_id; ?>" data-action="replace_client_for_interview">Replace</button>&nbsp;
