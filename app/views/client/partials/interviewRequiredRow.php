    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <thead>
                        <tr>
                            <th colspan="2" class="project-name">
                                ...
                                <span class="label label-warning pull-right">Required on <?php echo Utils\Helper::dateTimeFromDb($interview->updated_at); ?></span>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <div class="text-left">
                    <button type="button" class="btn btn-primary btn-sm revoke_interview_client confirm" data-action="revoke_invitation_to_interview" data-id="<?php echo $interview->interview_id; ?>">Revoke Invitation</button>
                </div>
                </div>
        </div>
    </div>
